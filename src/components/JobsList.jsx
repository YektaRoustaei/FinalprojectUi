...
const JobsList = () => {
    ...
    const [searchCity, setSearchCity] = useState(''); // For search box city
    const [selectedCity, setSelectedCity] = useState([]); // For filter component
    ...
    useEffect(() => {
        ...
        fetchJobs();
    }, [token, searchTerm, searchCity, selectedCity, selectedJobType, currentPage]); // Include all dependencies
    ...
    const handleSearchParamsChange = (term, city) => {
        setSearchTerm(term);
        setSearchCity(city); // Set search box city
    };
    ...
    return (
        <div className="w-full">
            ...
            <div className="w-full m-4">
                <SearchBox onSearchParamsChange={handleSearchParamsChange}/>
            </div>
